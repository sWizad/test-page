...
class Scene {
  ...
  drawSubPlanes(currentPlane, texture_c, texture_a, texture_b, texture_basis, projectionMatrix, modelViewMatrix, planeMV, sfmProjectionMatrix, cw, ch, depths, atc, cameraPos) {
    const gl = this.gl;
